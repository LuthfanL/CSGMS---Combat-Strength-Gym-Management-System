...
const features = [
  {
    ...
    description: 'Tidak perlu lagi membawa kartu member. Cukup tampilkan QR Code dari ponsel, lalu lakukan check-in dalam hitungan detik.',
    icon: QrCode,
  ...
  },
  {
    ...
    description: 'Lihat status keanggotaan, riwayat kehadiran, dan pembayaran kapan saja melalui satu dashboard yang mudah digunakan.',
  ...
  },
  {
    ...
    description: 'Perpanjang keanggotaan dengan pembayaran melalui QRIS atau tunai. Semua transaksi langsung tercatat sehingga lebih mudah untuk dipantau.',
    icon: CreditCard,
  ...
  },
  {
    ...
    description: 'Tidak perlu khawatir lupa memperpanjang keanggotaan. Sistem akan mengirimkan pengingat beberapa hari sebelum masa aktif berakhir.',
    icon: BellRing,
    ...
    <div id="features" className="relative py-24 bg-zinc-50 dark:bg-[#121212] overflow-hidden border-y border-border dark:border-white/5 transition-colors">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            Semua kebutuhan keanggotaan gym dapat diakses dengan mudah, mulai dari check-in, pembayaran, hingga melihat riwayat aktivitas dalam satu aplikasi.
          </motion.p>
        </div>
