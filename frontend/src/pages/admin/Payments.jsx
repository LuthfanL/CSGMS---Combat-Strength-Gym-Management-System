  ...
  const renderTableRows = (payments) => {
    return payments.map((payment) => (
      <tr key={payment.id} className="hover:bg-background/50 transition-colors">
        ...
        <td className="px-4 py-3 text-center">
          <span className={`px-2 py-0.5 rounded text-[10px] font-medium border ${payment.status === 'Menunggu'
        ...
        <td className="px-4 py-3">
          {payment.status === 'Menunggu' ? (
            ...
            <div className="flex flex-col justify-center gap-2">
              <button onClick={() => handleViewInvoice(payment)} className="px-2 py-1.5 bg-background border border-border text-foreground hover:bg-border/50 rounded transition-colors flex items-center justify-center gap-1.5 text-[10px] font-bold" title="Lihat Invoice">
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm flex flex-col">
        <div className="p-4 border-b border-border flex flex-col sm:flex-row justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <select className="bg-background border border-border rounded-lg px-3 py-2 h-[38px] text-sm text-foreground focus:ring-primary focus:border-primary transition-colors">
          ...
          <div className="relative bg-card w-full max-w-md rounded-2xl shadow-2xl border border-border overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-[10px] text-foreground/70">Jl. Raya Kebon Jeruk No. 27, Jakarta Barat</p>
                <p className="text-[10px] text-foreground/70">Telp: 0812-3456-7890 | Email: admin@combatstrength.com</p>
                <p className="text-xs font-bold text-foreground/50 mt-2">Bukti Pembayaran Lunas</p>
              </div>
