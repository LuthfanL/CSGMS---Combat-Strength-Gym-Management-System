            ...
            <tbody className="divide-y divide-border">
              <tr className="hover:bg-background/50 transition-colors">
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="text-foreground font-medium">Hari ini, 10:23</div>
                  <div className="text-[10px] text-foreground/50">27 Okt 2023</div>
                </td>
              ...
              <tr className="hover:bg-background/50 transition-colors">
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="text-foreground font-medium">Hari ini, 09:15</div>
                  <div className="text-[10px] text-foreground/50">27 Okt 2023</div>
                </td>
                <td className="px-4 py-3">
              ...
              <tr className="hover:bg-background/50 transition-colors">
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="text-foreground font-medium">Kemarin, 16:45</div>
                  <div className="text-[10px] text-foreground/50">26 Okt 2023</div>
                </td>
                <td className="px-4 py-3">
                  <div className="font-medium text-foreground">Admin Satu</div>
                  <div className="text-[10px] text-foreground/50">admin1@...</div>
              ...
              <tr className="hover:bg-background/50 transition-colors">
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="text-foreground font-medium">Kemarin, 14:20</div>
                  <div className="text-[10px] text-foreground/50">26 Okt 2023</div>
                </td>
                <td className="px-4 py-3">
